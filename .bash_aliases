...
alias vpn-htb='sudo openvpn --config /home/ploof/VPN/lab_PloofDoodle.ovpn'
alias vpn-cpts='sudo openvpn --config /home/ploof/VPN/cpts_exam.ovpn'
alias vpn-academy='sudo openvpn --config /home/ploof/VPN/academy-regular.ovpn'
alias vpn-release_arena='sudo openvpn --config /home/ploof/VPN/HTB-Release-Arena.ovpn'
alias vpn-starting_point='sudo openvpn --config /home/ploof/VPN/HTB-Starting-Point.ovpn'
alias vpn-thm='sudo openvpn --config /home/ploof/THM.ovpn'
...
alias nmapz='/home/ploof/scripts/gen_nmap.py; while read item; do sudo nmap -sV -sC -sU -sS $item; done < nmap.txt; rm mscan.txt nmap.txt'
...
alias wpscan='wpscan -e ap,t,u --api-token FwiJoHbz1skUWqpxHJPUrvp440hhMrvE75aD6tdfzm4 --url $1'
alias wes-ng='python /home/ploof/scripts/windows/wesng/wes.py'
alias aslr_off='echo 0 | sudo tee /proc/sys/kernel/randomize_va_space'
alias gen_nmap='/home/ploof/scripts/gen_nmap.py'
...
alias android_studio='/home/ploof/apps/android-studio/bin/studio.sh'
alias rustscan='docker run -it --rm --name rustscan rustscan/rustscan:1.10.0'
alias pipz_upgrade='pip freeze > requirements.txt; pip install -r requirements.txt --upgrade; rm requirements.txt;'
alias ghidra_auto='python3 /home/ploof/apps/auto_ghidra.py'
alias pwninit='/home/ploof/apps/pwninit --template-path ~/.config/pwninit-template.py; sed -n "4,6p" solve.py; rm solve.py; mv *_patched $1'
...
alias enum4linux='python /home/ploof/scripts/enum4linux-ng/enum4linux-ng.py'
alias subbrute='python /home/ploof/apps/subbrute/subbrute.py'
alias mobsf_emulator='emulator -avd $1 -writable-system -no-snapshot'
alias codemerx='/home/ploof/apps/codemerx/bin/CodemerxDecompile'
alias webdavup='sudo wsgidav --host=$1 --port=$2 --root=/tmp --auth=anonymous'
alias username-anarchy='ruby /home/ploof/apps/username-anarchy/username-anarchy'
alias xs-strike='python /home/ploof/apps/XSStrike/xsstrike.py'
alias jwt_tool='python /home/ploof/apps/jwt_tool/jwt_tool.py'

alias noPac.py='sudo python /opt/noPac/noPac.py'
alias noPacScanner.py='sudo python /opt/noPac/scanner.py'
alias ligoloUP='
sudo ip tuntap add user ploof mode tun ligolo
...
{ 
    ...
    sudo nmap -p"${ports}" -sC -sV "$target_ip" -oA "$target_ip";
}